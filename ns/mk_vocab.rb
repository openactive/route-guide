...
class Vocab
  ...
  TITLE = "OpenActive Namespace Vocabulary Terms".freeze
  DESCRIPTION = %(This document describes the vocabulary used in the Modelling Opportunity Data specification.).freeze
  ...
  def initialize
    ...
    @commit = "https://github.com/openactive/routes/ns/commit/" + git_info[0].split.last
